...
In a separate tab, start up the javascript bundle server:

```
$ yarn start
```

Follow the Expo instructions for viewing your app. Don't forget to leave this server running. Whenever you want to progress forward, simply check out the next stage. For example: 
